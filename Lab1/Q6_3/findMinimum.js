...
export default function FindMinimum() {
  ...
  return (
    <View> 
      <Text>Number 1:</Text>
      <TextInput value={number1} onChangeText={
        (text1) => setNumber1(text1)}></TextInput>
      <Text >Number 2:</Text>
      <TextInput value={number2} onChangeText={
        (text2) => setNumber2(text2)}></TextInput>
      <Text>Number 3:</Text>
      <TextInput value={number3} onChangeText={
        (text3) => setNumber3(text3)}></TextInput>
